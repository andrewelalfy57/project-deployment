...
export function CreateTaskDialog() {
  ...
  async function onSubmit(data: TaskFormValues) {
    ...
    try {
      ...
      const response = await fetch("https://backend-production-197e.up.railway.app/tasks");
      ...
      const createResponse = await fetch("https://backend-production-197e.up.railway.app/tasks", {
        method: "POST",
